...
#*******************************************************************************
## Assignment: Plot1.R and plot1.png
#*******************************************************************************
## 1. Get the data 
## 2. convert the date variable to Date class
## 3. Subset the data, Dates for 2007-02-01 and 2007-02-02
## 4. Make and save plot 1 
...
## 3. Subset the data: Dates for 2007-02-01 and 2007-02-02
householdpowerData <- householdpowerData[(Date >= "2007-02-01") & (Date <= "2007-02-02")]

                                                           

## 4. Make and save plot 1

hist(householdpowerData[, Global_active_power], main="Global Active Power", col = "red"
