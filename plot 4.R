...
#*******************************************************************************
## Assignment: Plot4.R and plot4.png
#*******************************************************************************
## 1. Get the data 
...
## 4. Make and save plot 4: it consists of 4 plots

#*******************************************************************************
## 1. Load your data: 
## I used  fread  "data.table" package because it loads large data files faster than read.table
householdpowerData <- data.table::fread(input = "household_power_consumption.txt"
                                        , na.strings="?"
)
...
# Plot 1
plot(householdpowerData[, dateTime], householdpowerData[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(householdpowerData[, dateTime],householdpowerData[, Voltage], type="l", xlab="datetime", ylab="Voltage")

# Plot 3
plot(householdpowerData[, dateTime], householdpowerData[, Sub_metering_1], type="l", xlab="", ylab="Energy sub metering")
lines(householdpowerData[, dateTime], householdpowerData[, Sub_metering_2], col="red")
lines(householdpowerData[, dateTime], householdpowerData[, Sub_metering_3],col="blue")
...
# Plot 4
plot(householdpowerData[, dateTime], householdpowerData[,Global_reactive_power], type="l", xlab="datetime", ylab="Global_reactive_power")
